...
public partial class SU25LeopardDBDbContext : DbContext
{
    public SU25LeopardDBDbContext()
    {
    }

    public SU25LeopardDBDbContext(DbContextOptions<SU25LeopardDBDbContext> options)
        : base(options)
    {
    }
