...
namespace PRN232_SU23_SE170578.api.Data
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        public virtual DbSet<LeopardAccount> LeopardAccounts { get; set; } = null!;
        public virtual DbSet<LeopardProfile> LeopardProfiles { get; set; } = null!;
        public virtual DbSet<LeopardType> LeopardTypes { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LeopardProfile>(entity =>
            {
                ...
                entity.HasOne(d => d.LeopardType)
                    .WithMany(p => p.LeopardProfiles)
