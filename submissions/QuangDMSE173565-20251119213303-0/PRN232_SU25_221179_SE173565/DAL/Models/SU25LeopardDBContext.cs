...
public partial class SU25LeopardDBContext : DbContext
{
    ...
    public virtual DbSet<LeopardAccount> LeopardAccount { get; set; }

    public virtual DbSet<LeopardProfile> LeopardProfile { get; set; }

    public virtual DbSet<LeopardType> LeopardType { get; set; }

//    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
//        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-4ESNLSKM\\QUANGDO;Initial Catalog=SU25LeopardDB;User ID=sa;Password=12345;Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<LeopardProfile>(entity =>
        {
            ...
            entity.HasOne(d => d.LeopardType).WithMany(p => p.LeopardProfile)
