...
public partial class Su25leopardDbContext : DbContext
{
    ...
    public virtual DbSet<Models.LeopardType> LeopardTypes { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Models.LeopardType>(entity =>
        {
            entity.ToTable("LeopardType");

            entity.Property<string>(e => e.Description).HasMaxLength(1000);
            entity.Property<string>(e => e.LeopardTypeName).HasMaxLength(250);
            entity.Property<string>(e => e.Origin).HasMaxLength(250);
        });
